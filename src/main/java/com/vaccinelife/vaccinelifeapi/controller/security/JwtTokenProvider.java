...
public class JwtTokenProvider {
    ...
    // JWT 토큰 생성
    public String createToken(String userPk, UserRole roles, String nickname, String type,int degree, String gender, int age, Boolean disease, String afterEffect) {
